...
controller.Index = async (req, res, next) => {
  /* 
    ...
    #swagger.parameters['type'] = { default: 'level', description: 'Some description...' }
    #swagger.parameters['value'] = { description: 'Some description...' }
    #swagger.parameters['limit'] = { default: 10, description: 'Some description...' }
    #swagger.parameters['page'] = { default: 1, description: 'Some description...' }
  */
  try {
